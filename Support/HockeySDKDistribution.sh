...
cp -R "${SRCROOT}/${DEVICE_DIR}/include/HockeySDK/BITHockeyLogger.h" "${INSTALL_DIR}/Headers/"
...
cp -R "${SRCROOT}/${DEVICE_CRASH_ONLY_DIR}/include/HockeySDK/BITHockeyLogger.h" "${INSTALL_DIR}/Headers/"
...
cp -R "${SRCROOT}/${DEVICE_EXTENSIONS_CRASH_ONLY_DIR}/include/HockeySDK/BITHockeyLogger.h" "${INSTALL_DIR}/Headers/"
